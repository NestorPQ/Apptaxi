...
<body class="d-flex flex-column min-vh-100">
  <div class="flex-grow-1">
    <footer class="bg-dark-gradient footer fixed-bottom">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-xl-6">
                <form class="d-flex flex-row mb-2 p-1 bg-white input-group">
                  <input type="email" class="form-control rounded-0 border-0" placeholder="tu@correo.com" />
                  <button class="btn btn-secondary rounded-0 flex-shrink-0" type="submit">
                    Suscribe
                  </button>
                </form>
              </div>
            ...
            <div class="col-sm-6 col-lg-3 my-4">
              ...
              <div class="white-link">
                <div class="d-flex pb-3">
                  ...
                  <div class="col ps-3">
                    <small class="text-white text-muted">29 March 2021</small>
                    <h6 class="font-w-500 h6 m-0">
                      <a class="text-white" href="#">Estilo de publicación de blog de muestra de lenguaje Markdown</a>
                    </h6>
                  </div>
                </div>
                <!-- <div class="d-flex">
